...
reviewed code, never from this file):
    ...
    PYTHONPATH=src python3 outputs/e1_tail_check.py runs/<log>.json PRESENT|REST|REST_SHUT|HOME [window_s]
    PYTHONPATH=src python3 outputs/e1_tail_check.py --selftest
